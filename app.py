...
root = Tk()
root.title("Steganography - Hide a secret Text Messege in an Image")
root.geometry("700x500+250+200")
...
Label(root,text="Steganography Project",bg="#2d4155",fg="white",font="arial 25 bold").place(x=100,y=20)
...
text1 = Text(f2,font="Rboto 20",bg="white",fg="black",relief=GROOVE,wrap=WORD)
